...
class OAuth2Middleware
{
     ...
     * @codeCoverageIgnore
     *
     * @param MomoApiTokenInterface $token
     */
    public function setToken(MomoApiTokenInterface $token)
    {
        $this->token = $token;
    }
     ...
     *
     * @return MomoApiTokenInterface|null
     ...
     * @codeCoverageIgnore
     *
     * @param MomoApiTokenRepositoryInterface $tokenRepository
     */
    public function setTokenRepository(MomoApiTokenRepositoryInterface $tokenRepository)
    {
     ...
     * @codeCoverageIgnore
     *
     * @return MomoApiTokenRepositoryInterface
     */
