...
class Collection extends Product
{
    ...
    public function __construct($headers = [], $middleware = [], ClientInterface $client = null)
    {
        ...
        $this->subscriptionKey = config('app.mtn-momo.products.collection.key');
        $this->clientId = config('app.mtn-momo.products.collection.id');
        $this->clientSecret = config('app.mtn-momo.products.collection.secret');
        $this->clientCallbackUri = config('app.mtn-momo.products.collection.callback_uri');

        $this->tokenUri = config('app.mtn-momo.products.collection.token_uri');
        $this->transactionUri = config('app.mtn-momo.products.collection.transaction_uri');
        $this->transactionStatusUri = config('app.mtn-momo.products.collection.transaction_status_uri');
        $this->accountStatusUri = config('app.mtn-momo.products.collection.account_status_uri');
        $this->accountBalanceUri = config('app.mtn-momo.products.collection.account_balance_uri');
        $this->accountHolderInfoUri = config('app.mtn-momo.products.collection.account_holder_info_uri');
        $this->partyIdType = config('app.mtn-momo.products.collection.party_id_type');
