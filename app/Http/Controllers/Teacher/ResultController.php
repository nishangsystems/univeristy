...
class ResultController extends Controller
{
    public function assigncourse(){
        ...
        return view('user.course.assigncourse')->with($data);
     }

     public function updatecourses(){
        return view('user.course.updatecourse');
    }
     ...
     public function contoassign(Request $request){
        ...
        return view('user.course.contoassign')->withLid($lid)->withSid($sid)->withDid($did);
     }
     ...
     public function assigningsubj($pid,$lid,$sid){
         ...
         return view('user.course.assigntolecturer')->with($data);
     }
