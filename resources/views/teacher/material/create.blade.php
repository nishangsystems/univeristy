...
<div class="row m-4">
          <div class="col-lg-12">
                <form class="cmxform form-horizontal form m-4 py-4 style-form" method="post" action="{{route('material.save', [request('layer'), request('layer_id'), request('campus_id') ?? 0])}}" enctype="multipart/form-data">
                {{csrf_field()}}
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{route('material.index', [request('layer'), request('layer_id'), request('campus_id') ?? 0])}}" class="btn btn-danger btn-xs m-2" type="button">{{__('text.word_cancel')}}</a>
                        </div>
                    </div>
                </form>
          </div>
