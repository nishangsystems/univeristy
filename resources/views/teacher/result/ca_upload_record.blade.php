...
@section('section')
   <div class="py-2 container-fluid">
        <div class="row my-4 container p-3 shadow">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-2">
                <select class="form-control" name="class" id="form_class" required readonly>
                    <option></option>
...
@section('script')
    <script>
        let submit_form = function(){
            ...
            let url = "{{ route('user.results.ca.upload_report', ['program_level'=>'__CLID__', 'semester'=>'__STR__', 'year'=>'__YR__']) }}".replace('__CLID__', _cl).replace('__STR__', _sm).replace('__YR__', _yr);
            window.location = url
        }
    </script>
@endsection