...
@section('script')
    <script>
        let submit_form = function(){
            ...
            let url = "{{ route('user.results.exam.upload_report', ['program_level'=>'__CLID__', 'semester'=>'__STR__', 'year'=>'__YR__']) }}".replace('__CLID__', _cl).replace('__STR__', _sm).replace('__YR__', _yr);
            window.location = url
        }
    </script>
@endsection