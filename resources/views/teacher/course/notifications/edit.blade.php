...
<div class="row m-4">
          <div class="col-lg-12">
                <form class="cmxform form-horizontal form m-4 py-4 style-form" method="post" action="{{route('course.notification.update', [request('course_id'), request('id')])}}">
                {{csrf_field()}}
                    ...
                    <div class="form-group ">
                        ...
                        <textarea class="form-control w-100"  required name="message" id="content">{{$item->message}}</textarea>
                        </div>
                    </div>
