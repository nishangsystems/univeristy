                    ...
                    <tbody class="text-uppercase text-left">
                        ...
                        @foreach($results->where('student_id', '=', $student->id) as $res)
                            ...
                            <tr class="border-top border-bottom border-secondary border-dashed">
                                ...
                                <td class="border-left border-right border-light">{{$res->ca_score + $res->exam_score}}</td>
                                <td class="border-left border-right border-light">{{$res->grade()->grade ?? '----'}}</td>
                                <td class="border-left border-right border-light">{{$res->grade()->remark ?? '----'}}</td>
                            </tr>
                            @endif
                        @endforeach
                        <tr class="border border-secondary text-capitalize h4 fw-bolder">
                            ...
                            <td colspan="7" class="text-center">{{__('text.total_courses_passed')}} : <span class="px-3">{{$results->where('total()', '>=', 50)->count()}}</span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
