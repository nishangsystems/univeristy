                            ...
                            <thead class="text-capitalize">
                                <tr class="border-bottom border-white">
                                    <th colspan="6" class="text-center">
                                        <form action="{{ route('admin.result.coded.course.import.ca.undo', [$year->id??'', $semester->id??'', $course->id??'']) }}" method="post" class="row">
                                            @csrf
                                            ...
                                            <div class="col-sm-4 col-xl-4"><button class="btn btn-warning rounded form-control">@lang('text.clear_ca')</button></div>
                                        </form>
                                    </th>
                                </tr>
                                <tr class="border-bottom border-white">
