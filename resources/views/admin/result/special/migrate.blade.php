                        ...
                        <table>
                            ...
                            <tbody>
                                <tr class="border-top border-bottom">
                                    ...
                                    <td>DNT23D023</td>  <td>23</td> <td>54</td>
                                </tr>
                                <tr class="border-top border-bottom">
                                    {{-- <td class="bg-light">2</td>   --}}
                                    <td>DNT23D003</td>  <td>20</td> <td>50</td>
                                </tr>
                                <tr class="border-top border-bottom">
                                    {{-- <td class="bg-light">3</td>   --}}
                                    <td>DNT23D102</td>  <td>17</td> <td>58</td>
                                </tr>
                                <tr class="border-top border-bottom">
                                    {{-- <td class="bg-light">4</td>   --}}
                                    <td>DNT23D021</td>  <td>25</td> <td>45</td>
                                </tr>
                                <tr class="border-top border-bottom">
                                    {{-- <td class="bg-light">5</td>   --}}
                                    <td>DNT23D025</td>  <td>24</td> <td>39</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="col-lg-7">
                    <div class="container-fluid shadow rounded py-3">
                        <div class="py-2 my-3 alert alert-info text-center border-top border-bottom">
                            ...
                            <a class="btn btn-danger btn-sm rounded px-5 py-1 text-capitalize" onclick="clearResult(`{{ route('admin.result.migrate.clear', ['year'=>$year_id, 'semester'=>$semester_id, 'course_code'=>$course_code, 'class'=>$class_id]) }}`)"><b>{{ $delete_label }}</b></a>
                        </div>
...
@section('script')
    <script>
        ...
        let submit_form = function(){
            ...
            let url = "{{ route('admin.result.migrate', ['year'=>'_YR_', 'semester'=>'_SMST_', 'course_code'=>'_CCODE_', 'class'=>'_CLS_']) }}".replace('_YR_', year).replace('_SMST_', semester).replace('_CCODE_', `${ccode}`).replace('_CLS_', _class);
            window.location = url;
        }
