...
@section('section')
    ...
    <div class="col-sm-12">
        <p class="text-muted">
           <a href="{{route('admin.result_release.create')}}" class="btn btn-info btn-xs">Add releases</a>
        </p>
                    ...
                    @foreach($releases as $k=>$release)
                        <tr>
                            ...
                            <td class="d-flex justify-content-end align-items-center">
                                <a class="btn btn-xs btn-success" href="{{route('admin.result_release.edit',[$release->id])}}"><i class="fa fa-edit"> Edit</i></a> |
