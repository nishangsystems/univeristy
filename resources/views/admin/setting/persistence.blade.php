            ...
            <div class="card card-light my-3">
                <div class="card-body py-0">
                    <div class="row">
                        ...
                        <div class="col-lg-7 px-3 py-5 bg-light shadow">
                            ...
                            <div class="py-2 d-flex justify-content-end">
                                <button class="btn btn-primary btn-sm rounded form-control text-uppercase" type="submit">@lang('text.copy_data')</button>
                            </div>
                        </div>
                    </div>
                </div>
