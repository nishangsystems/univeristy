...
@section('section')
<div class="py-4">
    <form action="{{route('admin.stock.accept', request('id'))}}" method="get">
        <div class="row my-2">
        ...
        <div class="d-flex justify-content-end">
            ...
            <input type="submit" name="" id="" class="btn btn-sm btn-primary" value="{{__('text.word_receive')}}">
        </div>
    </form>
    ...
    <div class="py-3">
        <table class="table">
            ...
            <tbody>
                @foreach(\App\Models\Stock::find(request('id'))->transfers()->where(['type'=>'receive'])->orderBy('created_at', 'DESC')->get() as $transfer)
