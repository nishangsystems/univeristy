            ...
            @if(auth()->user()->campus_id == null)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @endif
                        <a href="{{route('admin.stock.edit', $item->id)}}" class="btn btn-sm btn-secondary">{{__('text.word_edit')}}</a>|
                        <a href="{{route('admin.stock.report', [$item->id])}}" class="btn btn-sm btn-info">{{trans_choice('text.word_report', 1)}}</a>|
