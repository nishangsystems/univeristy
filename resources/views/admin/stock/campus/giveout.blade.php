...
<div class="col-sm-12">
    ...
    <form method="get" action="{{route('admin.stock.campus.give', [request('campus_id'), request('id')])}}">
    ...
    <div class="py-3">
        @php
            ...
            $stks = \App\Models\Stock::find(request('id'))->studentStock(request('campus_id'))->where(['type'=>'givable', 'year_id'=>$c_year])->get();
            // dd($stks);
            $k = 1;
        @endphp
        <table class="table">
