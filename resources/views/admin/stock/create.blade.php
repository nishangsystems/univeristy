...
@section('section')
<div class="py-3">
    <form action="{{route('admin.stock.save')}}" method="get">
        <div class="row my-2">
            <label class="col-md-3 col-lg-3 text-capitalize">{{__('text.word_name')}}</label>
            <div class="col-md-9 col-lg-9">
                <input type="text" name="name" class="form-control" id="" required placeholder="enter item name">
            </div>
        </div>
        <div class="row my-2">
            ...
            <div class="col-md-9 col-lg-9">
                <select name="type" class="form-control text-capitalize" required id="">
                    <option value=""></option>
                    <option value="givable">{{__('text.word_givable')}}</option>
                    <option value="receivable">{{__('text.word_receivable')}}</option>
                </select>
            </div>
        </div>
