                ...
                <table class="" id="hidden-table-info">
                    <thead>
                        ...
                        <tr class="text-capitalize border-bottom bg-dark text-white border-top">
                            ...
                            <th class="border-left border-right"><span style="writing-mode: vertical-rl !important; text-orientation: mixed important; transform: rotate(-180deg);">{{__('text.registration_fee_expected')}}</span></th>
                            <th class="border-left border-right"><span style="writing-mode: vertical-rl !important; text-orientation: mixed important; transform: rotate(-180deg);">{{__('text.registration_fee_paid')}}</span></th>
                            <!-- <th></th> -->
                        </tr>
                    </thead>
                    @php($k = 1)
                    <tbody id="content">
                        @foreach($data['students'] ?? [] as $student)
                            <tr class="border-bottom">
                                ...
                                <td class="border-left border-right bg-light border-2 border-dark">{{number_format($student['current_registration_fee'] ?? 0)}}</td>
                                <td class="border-left border-right bg-light border-2 border-dark">{{number_format($student['current_registration_fee_paid'] ?? 0)}}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
