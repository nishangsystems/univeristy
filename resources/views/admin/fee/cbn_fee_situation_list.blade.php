                ...
                <table class="" id="hidden-table-info">
                    <thead>
                        ...
                        <tr class="text-capitalize border-bottom bg-dark text-white border-top">
                            ...
                            <th class="border-left border-right"><span style="writing-mode: vertical-rl !important; text-orientation: mixed important;">{{__('text.registration_fee_expected')}}</span></th>
                            <th class="border-left border-right"><span style="writing-mode: vertical-rl !important; text-orientation: mixed important;">{{__('text.registration_fee_paid')}}</span></th>
                            <!-- <th></th> -->
                        </tr>
                    </thead>
                    @php($k = 1)
