    ...
    <div class="form-panel mb-5 ml-2">
        <form class="form-horizontal" role="form" method="POST" action="{{route('admin.boarding_fee.installments.store', $id)}}">
            <div class="form-group ">
                <label for="cname" class="control-label col-sm-2">Installment Name<span style="color:red">*</span></label>
                <div class="col-sm-3">
                ...
                <label for="cname" class="control-label col-sm-2 ">Amount <span style="color:red">*</span></label>
                <div class="col-md-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-flex justify-content-end  align-items-center">
                            <a class="btn btn-sm btn-success m-3" href="{{route('admin.boarding_fee.installments.edit',[$installment->boarding_fee_id, $installment->id])}}"><i class="fa fa-edit"> Edit</i></a> |
