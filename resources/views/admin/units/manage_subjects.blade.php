        ...
        <div class="row py-5">
            ...
            <div class="form-group col-md-3" data-role="subjects">
                <div class="custom-control custom-checkbox">
                    <input {{$parent->subjects->where('level_id', request('level_id'))->contains($subject)?'checked':''}} type="checkbox" class="custom-control-input toggle" value="{{$subject->id}}" name="subjects[]" id="subject{{$subject->id}}">
