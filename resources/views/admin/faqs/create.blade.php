...
<div class="row m-4">
          <div class="col-lg-12">
                <form class="cmxform form-horizontal form m-4 py-4 style-form" method="post" action="{{route('faqs.save')}}">
                {{csrf_field()}}

                    <div class="form-group text-capitalize">
                        <label class="col-md-2" > {{__('text.word_question')}}</label>
                        <div class="col-md-9">
                            <input type="text" name="question" required  placeholder="Title" class="form-control" />
                        </div>
                    </div>
                     ...
                     <div class="form-group ">
                        ...
                        <textarea class="form-control w-100"  required name="answer" id="content"></textarea>
                        </div>
                    </div>
