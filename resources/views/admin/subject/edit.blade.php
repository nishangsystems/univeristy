...
@section('section')
    ...
    <div class="mx-3">
        <div class="form-panel">
            <form class="cmxform form-horizontal style-form" method="post" action="{{route('admin.subjects.update', $subject->id)}}">
                {{csrf_field()}}
                ...
                <div class="form-group @error('name') has-error @enderror">
                    ...
                    <div class="col-lg-10">
                        <input class=" form-control" name="name" value="{{old('name', $subject->name)}}" type="text" required />
                    </div>
                </div>
                ...
                <div class="form-group @error('coef') has-error @enderror">
                    ...
                    <div class="col-lg-10">
                        <input class=" form-control" name="coef" value="{{old('coef', $subject->coef)}}" type="number" required />
                    </div>
                </div>
