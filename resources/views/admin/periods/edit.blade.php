        ...
        <form method="post" class="container">
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <input class="form-control" placeholder="start time" type="time" name="starts_at" value="{{ old('starts_at', $period->starts_at) }}" required>
                </div>
                <div class="col-md-5">
                    <span class="text-secondary fw-semibold text-capitalize">@lang('text.ends_at'):</span>
                    <input class="form-control" placeholder="end time" type="time" name="ends_at" value="{{ old('ends_at', $period->ends_at) }}" required>
                </div>
