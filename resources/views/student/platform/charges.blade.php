                ...
                <div class="text-center text-info h4">
                    ...
                    <form method="post" action="{{route('student.charge.pay')}}" id="poster-form">
                        ...
                        <div class="flex justify-content-center text-center my-4 py-2">
                            <span class="mx-3"><button type="submit" class="d-inline-block border-0 btn-primary rounded-md" onclick="event.preventDefault(); $('#p-channel').val('mtnmomo'); $('#poster-form').submit()"><img class="img img-responsive rounded" src="{{url('public/assets/images/mtn_momo.jpg')}}" style="height: 5rem; width: 8.5rem"></button></span>
                            <span class="mx-3"><button type="submit" class="d-inline-block border-0 btn-primary rounded-md" onclick="event.preventDefault(); $('#p-channel').val('orangemoney'); $('#poster-form').submit()"><img class="img img-responsive rounded" src="{{url('public/assets/images/Orange_Money.jpg')}}" style="height: 5rem; width: 8.5rem"></button></span>
                        </div>
                </form>
                </div>
            @endif
